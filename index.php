...
<div class="container">
<div class="header"> Welcome to Mini Bank </div>
<img src="bank.png" height=65% width=30% alt="Welcome to the Divya Mini Bank!" style="padding: 5px; margin-right: 8vw; margin-top:8vh; float:right"> 
</div>
<center>
<div class="contentbox">
  <h1> Facility Provided By Us </h1>
  ...
  <img src="user.jpg" alt="View Customers" width=50% height="30%" style="  border-radius: 10px;
    ...
    <h2><a href="customers.php"> Customer List </a></h2>
    <h4>Every data of Customer is Here. h4>
  </div>

  <div class="subcontent">
    <img src="transfer.jpg" alt="Transfer money" width=50% height="30%" style="  border-radius: 10px;
      border-style: double; display: block; margin: 5px;">
      <h2> <a href="sendmoney.php"> Money Transfer  </a></h2>
      <h4> Here you can send money from your account and safe transfer</h4>
    </div>

    <div class="subcontent">
      <img src="history.jpg" alt="Check Transactions" width=50% height="30%" style="  border-radius: 10px;
        border-style: double; display: block; margin: 5px;">
        <h2> <a href="transactions.php"> Transactions Details </a></h2>
        <h4> You can check the transactions Details here.</h4>
      </div>
</div>
<div class="pagebreak">
</div>
...
<div class="footer"> <center>
  Make it Simple and Interesting for Programmers
</center>
</div>
</center>
  </body>
